...
| P6 | Multi-algorithm adaptive selection | L0 | omni-ops | Normalization, reduction ops | strategies/perf_06_multi_algo_selection.md |
...
| P13 | Special algorithms & high-level APIs | L0 | omni-ops | Complex control flow, irregular access | strategies/perf_13_special_algorithms.md |
...
| P42 | Workspace zone reuse | L1 | omni-ops | Workspace 分区复用 | strategies/perf_42_workspace_zone_reuse.md |
...
| P62 | Sparse/dense dual-path dispatch | L1 | flash_attention | 稀疏/稠密双路径分发 (draft) | strategies/perf_62_sparse_dense_dual_path_dispatch_draft.md |
...
| P82 | Manual multi-buffer pipeline policy | L1 | omni-ops, manual | 手动 BufferPolicy 多阶段流水管理 | strategies/perf_82_manual_multi_buffer_pipeline_policy.md |
