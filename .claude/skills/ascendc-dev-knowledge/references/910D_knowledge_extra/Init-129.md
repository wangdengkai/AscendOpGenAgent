# Init<a name="ZH-CN_TOPIC_0000002554424471"></a>
...
<p id="p246271553317"><a name="p246271553317"></a><a name="p246271553317"></a>Tiling参数可以通过Host侧<a href="GetTiling-135.md">GetTiling</a>接口获取，并传递到Kernel侧使用。</p>
</td>
</tr>
</tbody>
</table>
