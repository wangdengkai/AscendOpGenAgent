# \_\_float2bfloat162\_rn<a name="ZH-CN_TOPIC_0000002554344199"></a>
...
```
__simt_callee__ inline bfloat16x2_t __float2bfloat162_rn(const float x)
```
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel__float2bfloat162_rn(__gm__ bfloat16x2_t* dst, __gm__ float* x)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = __float2bfloat162_rn(x[idx]);
}
```
