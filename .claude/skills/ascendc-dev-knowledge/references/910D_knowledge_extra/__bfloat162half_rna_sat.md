# \_\_bfloat162half\_rna\_sat<a name="ZH-CN_TOPIC_0000002523303910"></a>
...
饱和模式下，将bfloat16类型数据转换为half类型数据，并遵循CAST\_ROUND模式，返回转换后的值。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __bfloat162half_rna_sat(const bfloat16_t x)
```
...
饱和模式下将输入遵循CAST\_ROUND模式转换成的half类型数据。
