...
blockLen = 8：每个连续传输数据块包含8个DataBlock
...
- blockCount=2: 共2个连续传输数据块组
- blockLen=8: src 第1个连续传输数据块覆盖第1-8块(blk1-blk8)
- blockLen=8: src 第2个连续传输数据块覆盖第9-16块(blk1-blk8)
- srcGap=0: src 第1组与第2组之间间隔第0块(第8块尾与第9块头之间无间隔)
- blockLen=8: dst 第1个连续传输数据块覆盖第1-8块(blk1-blk8)
- blockLen=8: dst 第2个连续传输数据块覆盖第10-17块(blk1-blk8)
- dstGap=1: dst 第1组与第2组之间间隔第9块(1个DataBlock)
...
│          UB0          │       │          UB1          │
└───────────────────────┘       └───────────────────────┘
      DataCopy(GM0, UB0)             DataCopy(GM1, UB1)
...
│          GM0          │       │          GM1          │
└───────────────────────┘       └───────────────────────┘
      DataCopy(UB0, GM0)             DataCopy(UB1, GM1)
```
