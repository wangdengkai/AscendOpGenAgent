# \_\_bfloat162bfloat16\_rna<a name="ZH-CN_TOPIC_0000002523304868"></a>
...
```
__simt_callee__ inline bfloat16_t __bfloat162bfloat16_rna(const bfloat16_t x)
```
...
输入遵循CAST\_ROUND模式取整后的bfloat16\_t类型数据。
