# WaitIterateAll<a name="ZH-CN_TOPIC_0000002523303830"></a>
...
详细的使用样例请参考[IterateAll异步场景矩阵乘法](https://gitcode.com/cann/asc-devkit/tree/master/examples/03_libraries/01_matrix/matmul_async_iterate_all)。
