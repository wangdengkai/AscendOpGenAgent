# \_\_bfloat162bfloat16\_rz<a name="ZH-CN_TOPIC_0000002554343895"></a>
...
```
__simt_callee__ inline bfloat16_t __bfloat162bfloat16_rz(const bfloat16_t x)
```
...
输入遵循CAST\_TRUNC模式取整后的bfloat16\_t类型数据。
