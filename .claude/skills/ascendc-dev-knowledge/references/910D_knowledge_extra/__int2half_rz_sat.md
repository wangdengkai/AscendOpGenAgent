# \_\_int2half\_rz\_sat<a name="ZH-CN_TOPIC_0000002523304148"></a>
...
饱和模式下，将int32类型数据转换为half类型数据，并遵循CAST\_TRUNC模式。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __int2half_rz_sat(const int x)
```
...
饱和模式下输入的int32数据转换成的half数据，并遵循CAST\_TRUNC模式。
