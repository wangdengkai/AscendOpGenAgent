# \_\_bfloat1622float2<a name="ZH-CN_TOPIC_0000002523344834"></a>
...
```
__simt_callee__ inline float2 __bfloat1622float2(const bfloat16x2_t x)
```
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel__bfloat1622float2(__gm__ float2* dst, __gm__ bfloat16x2_t* x)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = __bfloat1622float2(x[idx]);
}
```
