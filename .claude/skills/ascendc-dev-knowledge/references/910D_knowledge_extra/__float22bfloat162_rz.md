# \_\_float22bfloat162\_rz<a name="ZH-CN_TOPIC_0000002554424329"></a>
...
```
__simt_callee__ inline bfloat16x2_t __float22bfloat162_rz(const float2 x)
```
...
将输入的两个分量遵循CAST\_TRUNC模式转换成的bfloat16x2\_t类型数据。
