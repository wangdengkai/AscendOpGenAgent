# \_\_ushort\_as\_half<a name="ZH-CN_TOPIC_0000002523303888"></a>
...
```
__simt_callee__ inline half __ushort_as_half(const unsigned short int x)
```
...
返回unsigned short int的按位重新解释为half的值。
