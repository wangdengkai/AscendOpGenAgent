# \_\_float22bfloat162\_rn<a name="ZH-CN_TOPIC_0000002523344826"></a>
...
```
__simt_callee__ inline bfloat16x2_t __float22bfloat162_rn(const float2 x)
```
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel__float22bfloat162_rn(__gm__ bfloat16x2_t* dst, __gm__ float2* x)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = __float22bfloat162_rn(x[idx]);
}
```
