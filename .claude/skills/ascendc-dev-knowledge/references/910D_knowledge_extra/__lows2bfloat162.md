# \_\_lows2bfloat162<a name="ZH-CN_TOPIC_0000002523303818"></a>
...
分别提取两个bfloat162输入的低16 位，并填充到bfloat162中。返回填充后的数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline inline bfloat16x2_t __lows2bfloat162(const bfloat16x2_t x, const bfloat16x2_t y)
```
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel__lows2bfloat162(__gm__ bfloat16x2_t* dst, __gm__ bfloat16x2_t* x, bfloat16x2_t* y)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = __lows2bfloat162(x[idx], y[idx]);
}
```
