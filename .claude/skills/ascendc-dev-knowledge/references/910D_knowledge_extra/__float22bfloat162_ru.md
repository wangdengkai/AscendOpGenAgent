# \_\_float22bfloat162\_ru<a name="ZH-CN_TOPIC_0000002523344432"></a>
...
```
__simt_callee__ inline bfloat16x2_t __float22bfloat162_ru(const float2 x)
```
...
将输入的两个分量遵循CAST\_CEIL模式转换成的bfloat16x2\_t类型数据。
