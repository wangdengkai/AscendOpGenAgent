# \_\_low2half<a name="ZH-CN_TOPIC_0000002554344771"></a>
...
```
__simt_callee__ inline half __low2half(const half2 x)
```
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel__low2half(__gm__ half* dst, __gm__ half2* x)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = __low2half(x[idx]);
}
```
