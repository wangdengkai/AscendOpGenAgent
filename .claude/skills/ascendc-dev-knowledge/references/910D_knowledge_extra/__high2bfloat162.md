# \_\_high2bfloat162<a name="ZH-CN_TOPIC_0000002554424735"></a>
...
```
__simt_callee__ inline bfloat16x2_t __high2bfloat162(const bfloat16x2_t x)
```
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel__high2bfloat162(__gm__ bfloat16x2_t* dst, __gm__ bfloat16x2_t* x)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = __high2bfloat162(x[idx]);
}
```
