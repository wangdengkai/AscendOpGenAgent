# \_\_half22float2<a name="ZH-CN_TOPIC_0000002554343505"></a>
...
```
__simt_callee__ inline float2 __half22float2(const half2 x)
```
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel__half22float2(__gm__ float2* dst, __gm__ half2* x)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = __half22float2(x[idx]);
}
```
