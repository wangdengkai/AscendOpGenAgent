# \_\_float22bfloat162\_rd<a name="ZH-CN_TOPIC_0000002554424091"></a>
...
```
__simt_callee__ inline bfloat16x2_t __float22bfloat162_rd(const float2 x)
```
...
将输入的两个分量遵循CAST\_FLOOR模式转换成的bfloat16x2\_t类型数据。
