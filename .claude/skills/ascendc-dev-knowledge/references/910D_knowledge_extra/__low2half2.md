# \_\_low2half2<a name="ZH-CN_TOPIC_0000002554423815"></a>
...
```
__simt_callee__ inline half2 __low2half2(const half2 x)
```
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel__low2half2(__gm__ half2* dst, __gm__ half2* x)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = __low2half2(x[idx]);
}
```
