# \_\_float22half2\_ru<a name="ZH-CN_TOPIC_0000002554423797"></a>
...
```
__simt_callee__ inline half2 __float22half2_ru(const float2 x)
```
...
将输入的两个分量遵循CAST\_CEIL模式转换成的half2类型数据。
