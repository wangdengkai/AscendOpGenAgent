# \_\_ushort\_as\_bfloat16<a name="ZH-CN_TOPIC_0000002523344194"></a>
...
```
__simt_callee__ inline bfloat16_t __ushort_as_bfloat16(const unsigned short int x)
```
...
返回unsigned short int的按位重新解释为bfloat的值。
