...
┌──────────────────────┬───────────┬───────────────┬────────┬──────────┬─────────┬─────────┬─────────────────┬─────────┬─────────┬──────────┬─────────┬──────────┬──────────┬──────────┬─────────┬──────────┬────────────┬────────────┬────────────┬────────────┬────────────┬───────────┬────────────┬────────────┐
│ Op Name              │ Task Type │ Task Duration │ Task W │ aicore_i │ aic_tot │ aic_mac │ aic_scalar_time │ aic_sca │ aic_mte │ aic_mte │ aic_mte2 │ aic_mtei │ aic_fixpip│ aic_fixpip│ aic_icach│ aiv_time(us)│ aiv_total_c │ aiv_vec_tim │ aiv_vec_rat │ aiv_scalar_ │ aiv_scalar_ │            │            │
├──────────────────────┼───────────┼───────────────┼────────┼──────────┼─────────┼─────────┼─────────────────┼─────────┼─────────┼──────────┼─────────┼──────────┼──────────┼──────────┼─────────┼──────────┼────────────┼────────────┼────────────┼────────────┼────────────┼───────────┼────────────┼────────────┤
...
┌──────────────────────┬───────────┬───────────────┬────────────┬───────────┬───────────┬───────────┬─────────────────┬─────────┬─────────┬──────────┬─────────┬───────────┬──────────┬──────────┬──────────┬─────────┬──────────┬──────────┬────────────┬────────────┐
│ Op Name              │ Task Type │ Task Duration │ Task Wai…  │ core      │ aic_total │ aic_mac   │ aic_scalar_time │ aic_sca │ aic_mte │ aic_mte2 │ aic_mte │ aic_fixpi │ aic_fixpip│ aic_icach│ aiv_time │ us       │ aiv_total_c│ aiv_vec_ti│ aiv_vec_rat│ aiv_scalar │
├──────────────────────┼───────────┼───────────────┼────────────┼───────────┼───────────┼───────────┼─────────────────┼─────────┼─────────┼──────────┼─────────┼───────────┼──────────┼──────────┼──────────┼─────────┼──────────┼──────────┼────────────┼────────────┤
│ matmul_ABshare_custom│ MIX_AIC   │ 24.46         │ 2596       │ 24.1      │ 44557     │ 2.486     │ 0.103           │ 19.46   │ 0.808   │ 4.851    │ 0.201   │ 7.862     │ 0.326    │ 9.533    │ 0.396    │ 0.029   │ 21.81    │ 80694    │ 0.022      │ 0.001      │
│ matmul_ABshare_custom│ MIX_AIC   │ 22.1          │ 2.8        │ 21.7      │ 40167     │ 2.486     │ 0.115           │ 19.718  │ 0.908   │ 4.856    │ 0.224   │ 8.074     │ 0.372    │ 9.759    │ 0.45     │ 0.026   │ 19.5     │ 72157    │ 0.022      │ 0.001      │
│ matmul_ABshare_custom│ MIX_AIC   │ 22.6          │ 2.76       │ 22.3      │ 41213     │ 2.487     │ 0.112           │ 19.883  │ 0.892   │ 4.856    │ 0.218   │ 8.002     │ 0.359    │ 9.719    │ 0.436    │ 0.028   │ 20.08    │ 74306    │ 0.022      │ 0.001      │
│ matmul_ABshare_custom│ MIX_AIC   │ 22            │ 2.86       │ 21.7      │ 40052     │ 2.487     │ 0.115           │ 19.363  │ 0.894   │ 4.847    │ 0.224   │ 7.766     │ 0.359    │ 9.394    │ 0.434    │ 0.027   │ 19.6     │ 72531    │ 0.022      │ 0.001      │
│ matmul_ABshare_custom│ MIX_AIC   │ 21.66         │ 10.58      │ 21.3      │ 39367     │ 2.487     │ 0.117           │ 19.229  │ 0.904   │ 4.857    │ 0.228   │ 7.713     │ 0.362    │ 9.426    │ 0.443    │ 0.027   │ 19.3     │ 71392    │ 0.022      │ 0.001      │
│ matmul_ABshare_custom│ MIX_AIC   │ 21.5          │ 13.88      │ 21.1      │ 39076     │ 2.486     │ 0.118           │ 19.179  │ 0.908   │ 4.867    │ 0.23    │ 7.807     │ 0.37     │ 9.685    │ 0.459    │ 0.026   │ 19.21    │ 71082    │ 0.022      │ 0.001      │
│ matmul_ABshare_custom│ MIX_AIC   │ 21.98         │ 12.86      │ 21.6      │ 39950     │ 2.486     │ 0.115           │ 19.512  │ 0.904   │ 4.845    │ 0.224   │ 7.894     │ 0.366    │ 9.542    │ 0.442    │ 0.027   │ 19.48    │ 72059    │ 0.022      │ 0.001      │
│ matmul_ABshare_custom│ MIX_AIC   │ 22.28         │ 12.94      │ 21.9      │ 40443     │ 2.486     │ 0.114           │ 19.52   │ 0.893   │ 4.843    │ 0.222   │ 8.095     │ 0.37     │ 9.774    │ 0.447    │ 0.027   │ 19.69    │ 72852    │ 0.022      │ 0.001      │
│ matmul_ABshare_custom│ MIX_AIC   │ 23.101        │ 12.7       │ 22.8      │ 42096     │ 2.486     │ 0.109           │ 20.162  │ 0.886   │ 4.852    │ 0.213   │ 8.286     │ 0.364    │ 9.943    │ 0.437    │ 0.027   │ 20.38    │ 75399    │ 0.022      │ 0.001      │
│ matmul_ABshare_custom│ MIX_AIC   │ 22.78         │ 22.6       │ 22.4      │ 41463     │ 2.486     │ 0.111           │ 20.383  │ 0.91    │ 4.835    │ 0.216   │ 8.186     │ 0.365    │ 9.862    │ 0.44     │ 0.026   │ 19.97    │ 73878    │ 0.022      │ 0.001      │
└──────────────────────┴───────────┴───────────────┴────────────┴───────────┴───────────┴───────────┴─────────────────┴─────────┴─────────┴──────────┴─────────┴───────────┴──────────┴──────────┴──────────┴─────────┴──────────┴──────────┴────────────┴────────────┘
```
