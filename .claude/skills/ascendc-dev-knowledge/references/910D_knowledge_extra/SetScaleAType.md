# SetScaleAType<a name="ZH-CN_TOPIC_0000002554344539"></a>

## 功能说明<a name="section618mcpsimp"></a>

[MxMatmul场景](MxMatmul场景.md)，设置scaleA矩阵的位置、数据格式、是否转置等信息，这些信息需要和Kernel侧的设置保持一致。如果不调用本接口，scaleA矩阵的信息将与[SetAType](SetAType.md)中设置的A矩阵的信息保持一致。
...
<td class="cellrowborder" valign="top" width="73.03%" headers="mcps1.2.4.1.3 "><p id="p6310416287"><a name="p6310416287"></a><a name="p6310416287"></a>scaleA矩阵的物理排布格式，详细介绍请参考<a href="MxMatmul场景.md#zh-cn_topic_0000002270097206_fig107863142019">数据格式</a>。</p>
