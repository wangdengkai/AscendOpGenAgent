# \_\_bfloat162bfloat162<a name="ZH-CN_TOPIC_0000002523303922"></a>
...
```
__simt_callee__ inline bfloat16x2_t __bfloat162bfloat162(const bfloat16_t x)
```
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel__bfloat162bfloat162(__gm__ bfloat16x2_t* dst, __gm__ bfloat16_t* x)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = __bfloat162bfloat162(x[idx]);
}
```
