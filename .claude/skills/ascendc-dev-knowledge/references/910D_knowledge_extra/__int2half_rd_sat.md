# \_\_int2half\_rd\_sat<a name="ZH-CN_TOPIC_0000002554423809"></a>
...
```
__simt_callee__ inline half __int2half_rd_sat(const int x)
```
...
饱和模式下输入的int32数据转换成的half数据，并遵循CAST\_FLOOR模式。
