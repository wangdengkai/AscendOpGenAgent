# \_\_int2half\_ru\_sat<a name="ZH-CN_TOPIC_0000002554343727"></a>
...
饱和模式下，将int32类型数据转换为half类型数据，并遵循CAST\_CEIL模式。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __int2half_ru_sat(const int x)
```
...
饱和模式下输入的int32数据转换成的half数据，并遵循CAST\_CEIL模式。
