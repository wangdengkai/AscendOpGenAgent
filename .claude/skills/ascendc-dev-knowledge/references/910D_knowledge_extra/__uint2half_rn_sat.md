# \_\_uint2half\_rn\_sat<a name="ZH-CN_TOPIC_0000002523303822"></a>
...
饱和模式下，将uint32类型数据转换为half类型数据，并遵循CAST\_RINT模式。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __uint2half_rn_sat(const unsigned int x)
```
...
饱和模式下输入的uint32数据转换成的half数据，并遵循CAST\_RINT模式。
