# \_\_float22half2\_rz<a name="ZH-CN_TOPIC_0000002523303914"></a>
...
```
__simt_callee__ inline half2 __float22half2_rz(const float2 x)
```
...
将输入的两个分量遵循CAST\_TRUNC模式转换成的half2类型数据。
