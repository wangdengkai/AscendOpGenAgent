...
时间轴:                              4 μs                 6 μs                 8 μs                10 μs                12 μs                14 μs
                                     │                    │                    │                    │                    │                    │
...
├─ MTE2_1            ───────────────────────────────[ WAI ]──────────────────────────────────────────────────────────────[ WAI ]─────────────
├─ MTE2_2            ┌──────────────────────────────────────────────┐  ┌──────────────────────────────────────────────┐
│                    │ [ MOV... ][ M... ][ MOV_OUT_TO... ][ MOV_OUT_TO_L1_M... ] │  │ [ MOV_OU... ][ MOV_OU... ][ MOV_OU... ][ MOV_OUT_TO_L1_M... ] │
│                    └──────────────────────────────────────────────┘  └──────────────────────────────────────────────┘
├─ MTE2_3            │ [ MOV_OU... ] [ MOV_OUT_TO_L1_M... ] [ MOV_OUT_TO_L1_M... ] │  │ [ MOV_OU... ] [ MOV_OUT_TO... ] [ MOV_OUT_TO_L1_M... ] │
├─ MTE2_4            │                                                            │  │                                                            │
├─ MTE2_5            │ [ MOV_OU... ] [ MOV_OUT_TO... ] [ MOV_OUT_TO_L1_MULTI_ND2NZ ] │  │ [ M... ] [ MOV_OUT_TO... ] [ MOV_OUT_TO... ]          │
├─ MTE2_6            │                                                            │  │                                                            │
├─ MTE2_7            │                                                            │  │                                                            │
...
├──────────┼──────────────┼──────────────┼──────────────────┼────────────────┼────────────────┼──────────────────┼──────────────────┼──────────────────┼──────────────────┼──────────────────┼──────────────────┼──────────────────┼──────────────────┼──────────────────┼──────────────────┤
│    0     │    cube0     │ 10.290909    │       1690       │    1.30303     │    0.028956    │     9.612727     │    0.213616      │    2.558788      │    0.056862      │    5.567879      │    0.123731      │    0.344242      │    0.00765       │    4.658182      │    0.103515      │
...
时间轴:
2 us            4 us            6 us            8 us            10 us           12 us           14 us
│               │               │               │               │               │               │

Flow events                                                                                 Processes
...
│ CUBE_1   │                 WAIT_FLAG                                                               │
│ CUBE_2   │                           ▌   ▌   ▌   ▌   ▌        W...   ▌  ▌                         │
│ CUBE_3   │                       WAI... WAIT_FLAG WAI... WAIT_FLAG WAI WAIT_FLAG     W...          │
│ CUBE_4   │                                                                        ▌                │
└───────────────────────────────────────────────────────────────────────────────────────────────────────┘

MTE1 (pid 50)
├───────────────────────────────────────────────────────────────────────────────────────────────────────┤
│ MTE1_1   │            W...  WAI...  W...  WAI...  WAI...  WA   WAI                                │
│ MTE1_2   │                           │    │    │    │    │    │                                    │
│ MTE1_3   │                                                                                         │
│ MTE1_4   │                          ▉         ▉                                                    │
│ MTE1_5   │                        ▉     ▉     ▉  ▉                                                 │
