# \_\_high2half<a name="ZH-CN_TOPIC_0000002554344773"></a>
...
```
__simt_callee__ inline half __high2half(const half2 x)
```
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel__high2half(__gm__ half* dst, __gm__ half2* x)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = __high2half(x[idx]);
}
```
